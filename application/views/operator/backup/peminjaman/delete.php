    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="box-body">
          Apakah anda yakin ingin menghapus permanen data peminjaman buku <strong> <?php echo $peminjaman->judul_buku?></strong> yang dipinjam oleh <strong><?php echo $peminjaman->nama_anggota?></strong> ?
          <!-- End Box Body -->
          </div>
        <!-- End Modal Body -->
       </div>
       <div class="modal-footer">
        <a class="btn btn-danger" href="<?php echo base_url('operator/peminjaman/hapus/'.$peminjaman->id_peminjaman) ?>">Hapus</a>
